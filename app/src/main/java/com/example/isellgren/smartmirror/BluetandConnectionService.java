...
public class BluetandConnectionService {
    private static final String TAG = "BluetandConnectionServ";
    ...
    public BluetandConnectionService(Context context)
    {
        mContext = context;
    ...
    private class ConnectThread extends Thread
    {
        ...
        public void run()
        {
            ...
            try
            {
                Log.d(TAG, "ConnectThread: Trying to create IsecureRfcommSocket using UUID: " + MY_UUID_INSECURE );
                tmp = mmDevice.createRfcommSocketToServiceRecord(deviceUUID);
            } catch (IOException e)
            {
                Log.e(TAG, "ConnectThread: Could not create IsecureRfcommSocket " + e.getMessage());
            }
            mmSocket = tmp;
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket) {
            ...
            //dismiss the progressdialog, when connection is  establish
            try {
        ...
        public void write(byte[] bytes) {
            ...
            Log.d(TAG, "write: Writing to outputsteam: " + text);
            try {
    ...
    public void write(byte[] out)
    {
        ...
        Log.d(TAG,"write: Writing Called");
        //preform the write
